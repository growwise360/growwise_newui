...
function hubReserveHref(locale: string): string {
  ...
  return createLocaleUrl(`${ACADEMIC_SEO_HUB_PATH}?filter=${query}#track-im1`, locale);
}
...
export function ImGetReadyIm1DetailSection({ locale, detail }: ImGetReadyIm1DetailSectionProps) {
  ...
  const defaultOpenFaqs = getDefaultOpenFaqValues(detail.faq.length, (idx) => `im1-faq-${idx}`);
    ...
    <div className="border-t border-slate-200 bg-slate-50/50">
        ...
        <div className="mx-auto max-w-[1100px]">
          <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            <h2 className="font-heading text-2xl font-bold text-[#1F396D] md:text-3xl">
              Common IM1 Mistake Patterns We Target
            </h2>
      ...
      <SectionContainer className="bg-transparent pt-0">
        <div className="mx-auto max-w-[1100px]">
          ...
          <ol className="mt-8 grid gap-5 md:grid-cols-2" aria-label="IM1 four-week cohort structure">
      ...
      <SectionContainer id="im1-regular-tutoring" className="scroll-mt-28 bg-transparent pt-0">
        <div className="mx-auto max-w-[720px]">
          <h2 className="font-heading text-2xl font-bold text-[#1F396D] md:text-3xl">
      ...
      <SectionContainer id="im1-faq" className="scroll-mt-28 bg-transparent pt-0">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-center font-heading text-2xl font-bold text-slate-900 md:text-3xl">
            IM1 <span className="text-[#F16112]">FAQ</span>
          </h2>
