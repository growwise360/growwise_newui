...
// Updated Grades 3–12 Programs with exact content from original
const k12Programs = [
  {
    id: 1,
    title: 'Math Courses',
  ...
  },
  {
    ...
    subItems: [
      { name: 'English Mastery: Grades 3–12', icon: '📚', description: 'Complete language arts curriculum' },
...
export default function Features() {
  ...
  return (
    <>
      ...
      {/* Enhanced Grades 3–12 Programs Section with Carousel */}
      <section className="py-12 px-4 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-3xl mb-8 text-center text-black">Grades 3–12 Academic Programs</h3>
