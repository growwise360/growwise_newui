  ...
  const allItems = [
    {
      ...
      title: 'Math Courses',
      description: 'Comprehensive Grades 3–12 math courses: Grade-level, Accelerated, and Integrated Math programs.',
      icon: Calculator,
    ...
    },
    {
      ...
      description: 'Comprehensive English Language Arts programs for Grades 3–12 students. Reading, writing, and grammar.',
      icon: BookOpen,
    ...
    },
    {
      ...
      description: 'Explore all our Grades 3–12 academic programs aligned with DUSD & PUSD standards.',
      icon: Award,
