export const HIGH_SCHOOL_MATH_PROGRAM_DETAILS = {
  sectionLabel: 'Program details',
  heading: 'High School Math — 3-Month Program',
} as const;
...
export const HIGH_SCHOOL_PROGRAM_OUTCOMES = [
  'Have course-specific gaps identified and a clear plan to close them',
  'Improve consistency on tests and multi-step problems under time pressure',
  'Build readiness for AP-level pacing and school-aligned assessments',
] as const;
