...
export default async function ContactPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const contactPageSchema = {
    ...
    "description": "Contact GrowWise in Dublin, CA. Call, email, or visit us at 4564 Dublin Blvd. Book a free assessment or ask about our Grades 3–12 tutoring and STEAM programs.",
