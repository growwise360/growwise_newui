        ...
        <article className="py-12 md:py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 mb-8">
                If you're in Dublin, CA, check out <strong>GrowWise Summer Camp</strong>—offering high-quality, engaging programs in <strong>math mastery, Roblox coding, web development, and AI/ML</strong> for Grades 3–12.
              </p>
