...
export default function SteamLayout({
  ...
  const serviceSchema = {
    ...
    "description": "STEAM programs for Grades 3–12 students in Dublin, CA: ML/AI coding, game development, and more. Hands-on project-based learning with expert instructors.",
    "url": `${baseUrl}/steam`,
